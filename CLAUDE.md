...
- **Каждый батч изменений — поднимать `GSGIT_VERSION_NAME`** в `gradle.properties`
  (иначе сборки из CI неотличимы: versionName одинаковый, а versionCode в настройках не виден).
