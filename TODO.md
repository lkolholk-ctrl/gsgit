...
- [x] **Активный пункт bottom-bar: овальная плашка вместо скруглённого прямоугольника** —
  `ui/screens/RepoBottomBar.kt`
  - Было: `RoundedCornerShape(16.dp)` (скруглённый прямоугольник).
  - Стало: `RoundedCornerShape(percent = 50)` (овал/stadium). Подтверждено на скрине (16:25).
